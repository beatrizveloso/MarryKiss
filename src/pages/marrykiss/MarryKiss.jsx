...
const GameScreen = ({ mode, config, onBack }) => {
  ...
  const characterPool = {
    ...
    characters: ['ben-10', 'damon-salvatore', 'eddie-munson', 'christian-grey', 'dean-winchester', 'toretto', 'george-weasley', 'thomas-shelby', 'detona-ralph', 'sherlock-holmes', 'jack-frost', 'raposa-do-zootopia', 'harry-potter', 'draco-malfoy', 'croods', 'javier-pena', 'romulo-estrela', 'peter-kavinsky', 'sam-winchester', 'tiago-larcerda', 'chandler-bing', 'derek-greys', 'colin-donnell', 'jacob-black', 'simon-basset', 'klaus-mikaelson']
  };
